(function () {
  ...
  describe('Products Controller Tests', function () {
    ...
    describe('vm.init()', function () {
      it('should vm.catetories as array', function () {
        $scope.vm.init();
        expect($scope.vm.categories.length).toEqual(4);
        expect($scope.vm.categories).toEqual([{ 'key': 'P', 'value': 'Product' }, { 'key': 'R', 'value': 'Rent' }, { 'key': 'S', 'value': 'Service' }, { 'key': 'E', 'value': 'Expense' }]);
      });
    });
