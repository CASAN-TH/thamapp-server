 ...
 */
describe('Product CRUD tests not include vat', function () {
          ...
          .end(function (productSaveErr, productSaveRes) {
            ...
            agent.get('/api/products')
              .end(function (productsGetErr, productsGetRes) {
                ...
                (products[0].buyprice).should.match(50);
                (products[0].saleprice).should.match(100);
                (products[0].isincludevat).should.match(false);
                (products[0].priceincludevat).should.match(107);
                (products[0].priceexcludevat).should.match(100);
                (products[0].saleaccount).should.match('10005');
                (products[0].buyaccount).should.match('10001');
  ...
  it('should not be able to save an Product if no saleprice is provided', function (done) {
    // Invalidate name field
    ...
    agent.post('/api/auth/signin')
      ...
      .end(function (signinErr, signinRes) {
        ...
        agent.post('/api/products')
          ...
          .end(function (productSaveErr, productSaveRes) {
            // Set message assertion
            (productSaveRes.body.message).should.match('Please fill Product saleprice');
  ...
  it('should not be able to save an Product if no isincludevat is provided', function (done) {
    // Invalidate name field
    ...
    agent.post('/api/auth/signin')
      ...
      .end(function (signinErr, signinRes) {
        ...
        agent.post('/api/products')
          ...
          .end(function (productSaveErr, productSaveRes) {
            // Set message assertion
            (productSaveRes.body.message).should.match('Please fill Product isincludevat');
          ...
          .end(function (productSaveErr, productSaveRes) {
            ...
            agent.put('/api/products/' + productSaveRes.body._id)
              ...
              .end(function (productUpdateErr, productUpdateRes) {
                ...
                (productUpdateRes.body.buyprice).should.match(100);
                (productUpdateRes.body.saleprice).should.match(150);
                (productUpdateRes.body.isincludevat).should.match(false);
                (productUpdateRes.body.priceincludevat).should.match(150 * 1.07);
                (productUpdateRes.body.priceexcludevat).should.match(150);
                // Call the assertion callback
                done();
              });
          });
    ...
    productObj.save(function () {
      request(app).get('/api/products/' + productObj._id)
        .end(function (req, res) {
          ...
          res.body.should.be.instanceof(Object).and.have.property('description', product.description);
          // Call the assertion callback
          done();
        });
    });
                  ...
                  .end(function (err, res) {
                    ...
                    agent.get('/api/products/' + productSaveRes.body._id)
                      ...
                      .end(function (productInfoErr, productInfoRes) {
                        ...
                        (productInfoRes.body.description).should.equal(product.description);
...
describe('Product CRUD tests include vat', function () {
          ...
          .end(function (productSaveErr, productSaveRes) {
            ...
            agent.get('/api/products')
              .end(function (productsGetErr, productsGetRes) {
                ...
                (products[0].description).should.match('Product Description');
                (products[0].buyprice).should.match(50);
                (products[0].saleprice).should.match(107);
                (products[0].isincludevat).should.match(true);
                (products[0].priceincludevat).should.match(107);
                (products[0].priceexcludevat).should.match(107 / 1.07);
                (products[0].saleaccount).should.match('10005');
                (products[0].buyaccount).should.match('10001');
                // Call the assertion callback
                done();
          ...
          .end(function (productSaveErr, productSaveRes) {
            ...
            agent.put('/api/products/' + productSaveRes.body._id)
              ...
              .end(function (productUpdateErr, productUpdateRes) {
                ...
                (productUpdateRes.body.buyprice).should.match(100);
                (productUpdateRes.body.saleprice).should.match(150);
                (productUpdateRes.body.isincludevat).should.match(true);
                (productUpdateRes.body.priceincludevat).should.match(150);
                (productUpdateRes.body.priceexcludevat).should.match(150 / 1.07);
