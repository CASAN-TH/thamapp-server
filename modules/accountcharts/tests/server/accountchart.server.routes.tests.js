...
describe('Accountchart CRUD tests', function () {
          ...
          .end(function (accountchartSaveErr, accountchartSaveRes) {
            ...
            agent.get('/api/accountcharts')
              .end(function (accountchartsGetErr, accountchartsGetRes) {
                ...
                (accountcharts[0].accountno).should.match('1234567');
                (accountcharts[0].accountname).should.match('Account Name');
          ...
          .end(function (accountchartSaveErr, accountchartSaveRes) {
            ...
            agent.post('/api/accountcharts')
              ...
              .end(function (accountchartSaveErr, accountchartSaveRes) {
                ...
                (accountchartSaveRes.body.message.toLowerCase()).should.containEql('accountno already exists');
    ...
    agent.post('/api/auth/signin')
      ...
      .end(function (signinErr, signinRes) {
        ...
        agent.post('/api/accountcharts')
          ...
          .end(function (accountchartSaveErr, accountchartSaveRes) {
            // Set message assertion
            (accountchartSaveRes.body.message).should.match('Please fill Accountchart accountno');
  ...
  it('should not be able to save an Accountchart if no accountname is provided', function (done) {
    ...
    agent.post('/api/auth/signin')
      ...
      .end(function (signinErr, signinRes) {
        ...
        agent.post('/api/accountcharts')
          ...
          .end(function (accountchartSaveErr, accountchartSaveRes) {
            // Set message assertion
            (accountchartSaveRes.body.message).should.match('Please fill Accountchart accountname');
      ...
      .end(function (signinErr, signinRes) {
        ...
        agent.post('/api/accountcharts')
          ...
          .end(function (accountchartSaveErr, accountchartSaveRes) {
            ...
            accountchart.accountno = 'WHY YOU GOTTA BE SO MEAN?';
            ...
            agent.put('/api/accountcharts/' + accountchartSaveRes.body._id)
              ...
              .end(function (accountchartUpdateErr, accountchartUpdateRes) {
                ...
                (accountchartUpdateRes.body.accountno).should.match('WHY YOU GOTTA BE SO MEAN?');
  ...
  it('should be able to get a single Accountchart if not signed in', function (done) {
    ...
    accountchartObj.save(function () {
      request(app).get('/api/accountcharts/' + accountchartObj._id)
        .end(function (req, res) {
          // Set assertion
          res.body.should.be.instanceof(Object).and.have.property('accountno', accountchart.accountno);
        ...
        .end(function (signinErr, signinRes) {
          ...
          agent.post('/api/accountcharts')
            ...
            .end(function (accountchartSaveErr, accountchartSaveRes) {
              ...
              (accountchartSaveRes.body.accountno).should.equal(accountchart.accountno);
                  ...
                  .end(function (err, res) {
                    ...
                    agent.get('/api/accountcharts/' + accountchartSaveRes.body._id)
                      ...
                      .end(function (accountchartInfoErr, accountchartInfoRes) {
                        ...
                        (accountchartInfoRes.body.accountno).should.equal(accountchart.accountno);
