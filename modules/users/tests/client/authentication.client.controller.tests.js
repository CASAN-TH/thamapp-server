...
(function () {
  ...
  describe('AuthenticationController', function () {
    ...
    describe('Logged out user', function () {
      ...
      describe('$scope.readPostcode()', function (PostcodesService) {

        it('should login with a correct user and password', function () {
          // Test expected GET request
          $httpBackend.when('GET', '/api/postcodes').respond(200);

          scope.readPostcode(true);
          $httpBackend.flush();

          // Test scope value
          expect(scope.postcode).toEqual(!undefined);
          // expect($location.url()).toEqual('/');
        });

      });
      describe('$scope.signin()', function (_PostcodesService_) {

        it('should login with a correct user and password', function (PostcodesService) {
          // Test expected GET request
        ...
        it('should fail to log in with nothing', function (PostcodesService) {
        ...
        it('should fail to log in with wrong credentials', function (PostcodesService) {
      ...
      describe('$scope.signup()', function (_PostcodesService_) {
        it('should register with correct data', function (PostcodesService) {
          // Test expected GET request
        ...
        it('should fail to register with duplicate Username', function (PostcodesService) {
          // Test expected POST request
