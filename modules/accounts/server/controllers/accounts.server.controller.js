...
// logic in here <<
// send account
exports.sendAp = function (req, res, next) {
  res.send('AP');
};

exports.sendAr = function (req, res, next) {
  res.send('AR');
};

exports.sendPv = function (req, res, next) {
  res.send('PV');
};

exports.sendRv = function (req, res, next) {
  res.send('RV');
};

exports.sendJv = function (req, res, next) {
  res.send('JV');
};
// send account end
// account end
