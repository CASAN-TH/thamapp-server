(function () {
  ...
  describe('Receivings Controller Tests', function () {
    ...
    describe('vm.setData() as set', function () {
      ...
      beforeEach(function () {
        $scope.vm.receiving.docdate = new Date();
      });
      ...
      it('should set Data', inject(function () {
        ...
        expect($scope.vm.receiving.docdate).toEqual(new Date($scope.vm.receiving.docdate) || new Date());
    ...
    describe('vm.selectCustomer()', function () {
      ...
      it('should vm.receiving.creditday', function () {
        ...
        expect($scope.vm.receiving.drilldate).toEqual($scope.vm.receiving.drilldate || new Date());
      });
    });
    ...
    describe('vm.calculate', function () {
      ...
      beforeEach(function () {
        $scope.vm.receiving.items = arrayProduct;
      });

      it('should vm.receiving.items', function () {
        ...
        expect($scope.vm.receiving.items[0].qty).toEqual($scope.vm.receiving.items[0].qty);
        ...
        expect($scope.vm.receiving.items[0]).toEqual($scope.vm.receiving.items[0]);
        expect($scope.vm.receiving.amount).toEqual($scope.vm.receiving.items[0].unitprice * $scope.vm.receiving.items[0].qty);
        expect($scope.vm.receiving.vatamount).toEqual($scope.vm.receiving.items[0].vatamount);
        expect($scope.vm.receiving.whtamount).toEqual($scope.vm.receiving.items[0].whtamount);
        expect($scope.vm.receiving.totalamount).toEqual($scope.vm.receiving.items[0].totalamount);
      });
    });
    ...
    describe('vm.changeUnitPrice(item) on-change', function () {
      ...
      it('should vm.changeUnitPrice(item) set item.unitprice', function () {
        $scope.vm.changeUnitPrice($scope.vm.receiving.items[0]);
        expect($scope.vm.receiving.items[0].unitprice).toEqual($scope.vm.receiving.items[0].product.priceexcludevat);
      });
    });
    ...
    describe('vm.removeProduct()', function () {
      ...
      it('should vm.removeProduct()', function () {
        ...
        $scope.vm.receiving.items.splice($scope.vm.index, 1);
        expect($scope.vm.receiving.items.length).toEqual(0);
      });
    });
