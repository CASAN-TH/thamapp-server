(function () {
  ...
  function routeConfig($stateProvider) {
    $stateProvider
      .state('reportreturnorder', {
        url: '/reportreturnorder',
        templateUrl: 'modules/returnorders/client/views/reportreturnorder.client.view.html',
        controller: 'ReportreturnorderController',
        controllerAs: 'vm'
      })
      .state('returndeliver', {
        url: '/returndeliver',
