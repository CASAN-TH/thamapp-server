...
var path = require('path'),
  ...
  pushNotiAuthenADM = { profile: process.env.PUSH_NOTI_PROFILE || 'prod', 
  ...
  pushNotiAuthenUSR = { profile: process.env.PUSH_NOTI_PROFILE || 'prod', 
  ...
  pushNotiAuthenDEL = { profile: process.env.PUSH_NOTI_PROFILE || 'prod', 
