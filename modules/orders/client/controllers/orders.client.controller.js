(function () {
  ...
  function OrdersController($scope, $state, $http, $window, Authentication, order, ShopCartService, ProductsService, Users) {
    ...
    $scope.printDiv = function (divName) {
      ...
      popupWin.document.open();
      popupWin.document.write('<!DOCTYPE html><html><head><title>TITLE OF THE PRINT OUT</title><link rel="stylesheet" type="text/css" href="lib/bootstrap/dist/css/bootstrap.css" /></head><body onload="window.print(); window.close();"><div>' + printContents + '</div></html>');
      popupWin.document.close();
    };
