...
describe('Payment CRUD tests', function () {
          ...
          .end(function (paymentSaveErr, paymentSaveRes) {
            ...
            agent.get('/api/payments')
              .end(function (paymentsGetErr, paymentsGetRes) {
                ...
                (payments[0].client.name).should.match('Company Name');
                (payments[0].items[0].product.name).should.match('Product Name');
          ...
          .end(function (paymentSaveErr, paymentSaveRes) {
            ...
            agent.post('/api/payments')
              ...
              .end(function (paymentSaveErr, paymentSaveRes) {
                ...
                (paymentSaveRes.body.message).should.match('11000 duplicate key error collection: mean-test.payments index: docno already exists');
    ...
    agent.post('/api/auth/signin')
      ...
      .end(function (signinErr, signinRes) {
        ...
        agent.post('/api/payments')
          ...
          .end(function (paymentSaveErr, paymentSaveRes) {
            // Set message assertion
            (paymentSaveRes.body.message).should.match('Please fill Payment client');
  ...
  it('should not be able to save an Payment if update product', function (done) {
    agent.post('/api/auth/signin')
      .send(credentials)
      .expect(200)
      .end(function (signinErr, signinRes) {
          ...
          .end(function (paymentSaveErr, paymentSaveRes) {
            ...
            agent.put('/api/payments/' + paymentSaveRes.body._id)
              ...
              .end(function (paymentUpdateErr, paymentUpdateRes) {
                ...
                (paymentUpdateRes.body._id).should.equal(paymentSaveRes.body._id);
                (paymentUpdateRes.body.docno).should.match('WHY YOU GOTTA BE SO MEAN?');
                (paymentUpdateRes.body.items.length).should.match(2);
                // Call the assertion callback
                done();
              });
          });
