...
(function () {
  // Responseorder Controller Spec
  describe('Responseorder Controller Tests', function () {
    // Initialize global variables
    var ResponseorderController,
      $scope,
      $httpBackend,
      $stateParams,
      $location,
    ...
    beforeEach(inject(function ($controller, $rootScope, _$location_, _$stateParams_, _$httpBackend_, _$state_, _Users_, _Authentication_, _RequestordersService_) {
      ...
      // Initialize the Responseorder controller.
      ResponseorderController = $controller('ResponseorderController as vm', {
        $scope: $scope
      });
    }));
    ...
    describe('update status response', function () {
      beforeEach(function () {
        // Mock Order in $scope
      ...
      it('vm.status response()', inject(function () {
