(function () {
  ...
  PurchasesController.$inject = ['$scope', '$state', '$window', 'Authentication', 'purchaseResolve', 'AccountchartsService'];

  function PurchasesController($scope, $state, $window, Authentication, purchase, AccountchartsService) {
    var vm = this;
